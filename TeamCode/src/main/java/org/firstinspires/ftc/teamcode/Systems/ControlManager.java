...
//        }
        QuickSpindexer.updateSpindexerResetIncluded(
                spinLeft && !(((!rev && (QuickSpindexer.hasBall[0] && QuickSpindexer.hasBall[1] && QuickSpindexer.hasBall[2]))) || driver.dpad_left || operator.left_trigger > 0.5 || operator.right_trigger > 0.5),
                spinRight && !rev,
