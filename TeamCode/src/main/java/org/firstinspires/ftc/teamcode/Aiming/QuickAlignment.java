...
public class QuickAlignment {
    ...
    public static final double SPEED_GAIN  =  0.2  ;   //  Forward Speed Control "Gain". e.g. Ramp up to 50% power at a 25 inch error.   (0.50 / 25.0)
    public static final double STRAFE_GAIN =  0.15 ;   //  Strafe Speed Control "Gain".  e.g. Ramp up to 37% power at a 25 degree Yaw error.   (0.375 / 25.0)
    public static final double TURN_GAIN   =  0.5  ;   //  Turn Control "Gain".  e.g. Ramp up to 25% power at a 25 degree error. (0.25 / 25.0)
    ...
    public static final double MAX_AUTO_TURN  = 1.0;   //  Clip the turn speed to this max value (adjust for your robot)
