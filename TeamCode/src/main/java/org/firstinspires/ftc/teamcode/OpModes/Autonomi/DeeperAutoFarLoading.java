...
@Config
@Autonomous(name = "DEEPER Far zone 9 (Uses human player + 1 spike mark)")
public class DeeperAutoFarLoading extends LinearOpMode {
    @Override
...
//        double waitTime = 0.0;
        ...
        Pose2d startPickup1 = new Pose2d(36.0, posMultiplier*-32.5, posMultiplier*Math.toRadians(-90.0));
        ...
        Pose2d endPickup2 = new Pose2d(64, posMultiplier*-62.0, posMultiplier*-Math.toRadians(10.0));
        ...
        TrajectoryActionBuilder pickup1 = drive.actionBuilder(startPickup1)
                .setTangent(posMultiplier*Math.toRadians(-90.0))
                .splineToLinearHeading(endPickup1, posMultiplier*Math.toRadians(-90.0), new TranslationalVelConstraint(4.0));
